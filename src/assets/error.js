export default {
  ...
  HostPerformanceAndMaxAllowedHostMustBePaired: 'Host performance and max allowed host number should both have value or both be none',
  PerformanceValueShouldNotBeZero: 'Performance value should greater than 0',
  MaxAllowedHostShouldNotBeZero: 'If specify the maximum allowed host count, it should be greater than 0',
  TAppNotSupportToHost: 'The tapp is not supported to be hosted, that usually means the tapp is not need long running.',
  TAppHostMachineIsFull: 'TAppHostMachineIsFull',
  TAppHostsIsFull: 'The tapp already has desired count of hosts that can not be hosted anymore',
  CmlMachineIsFullLoad: 'The CML machine is full loan that can not host anymore',
  CmlNotHostTheTApp: 'The CML not hosting the given TApp',
