<template>
  <div class="tea-page">
    ...
    <div class="t-step" v-if="step===1">
      <p>Please run the following command in your miner and prepare the TEA Id and Account.</p>
      ...
      <p>After command, you can get the following like below, remember it and go to next step.</p>
    ...
    <div v-if="step===2" class="t-step">
      ...
      <el-form :model="form" label-width="220px" :rules="rules" ref="form" class="tea-modal">
        ...
        <el-form-item label="Miner IP" prop="miner_ip">
          ...
          <TeaIconButton icon_style="font-size:18px;" tip="The IP address of your mining machine" icon="questionmark" />
        </el-form-item>

        <el-form-item label="Binding account" prop="account">
          <el-input v-model="form.account"></el-input>

          <TeaIconButton icon_style="font-size:18px;" tip="TEA address bind to miner." icon="questionmark" />
        </el-form-item>
    ...
    <div class="t-step" v-if="step===3">
      <div class="c-shell">
        <p style="font-weight:bold;">
          <span class="js_need_copy">sh -c "$(curl -fsSL https://raw.githubusercontent.com/tearust/delegator-resources/master/install.sh {{form.miner_id}} {{form.account}})"</span>
