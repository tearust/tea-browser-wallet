<template>
  <div class="tea-page">
    ...
    <p>
      ...
      <br/>
      Note that you need <b class="block">{{ form.miner_price }} COFFEE</b> to buy a mining machine and <b class="block">1000 TEA</b> available for your initial stake. More info is available <a href="https://github.com/tearust/teaproject/wiki/Mining#mining-machines-are-no-longer-free" class="t-wiki" target="_blank">on our wiki.</a>
      <br/>
